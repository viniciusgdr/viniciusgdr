...
export default function Home() {
  return (
    <div className=''>
      <div className="w-full py-12 min-h-screen h-full  bg-black/30 md:bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto">
          ...
          >
            Tire suas ideias do papel e transforme-as em realidade com meu serviço. Desenvolvo aplicações web escalaveis e mobile com as melhores tecnologias do
            mercado.
          </motion.p>
