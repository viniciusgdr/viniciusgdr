          ...
          <SwiperSlide key={index}>
            <div className="grid grid-cols-2 gap-4 grid-rows-2">
              {slide.images.map((image, index2) => {
                return image.url?.endsWith(".onion/") ? (
                  <div
                    key={index2}
                    className="relative rounded-lg overflow-hidden flex items-center justify-center group"
                    onClick={() => {
                      (
                        document.getElementById("modal_" + index2) as any
                      ).showModal();
                    }}
                  >
                    ...
                    <dialog id={"modal_" + index2} className="modal z-50">
                      <div className="modal-box bg-primary">
                        ...
                        <p className="py-4">
                          Este site é acessível apenas via Tor Browser. Para
                          acessar, certifique-se de que você está utilizando o
                          navegador correto.
                        </p>
                        <p>
                          <a
